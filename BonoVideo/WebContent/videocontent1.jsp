...
<div id="svw_main">
    ...
    <div id="sidebar">
        <ul class="svw_list">
        	<li><a href="VideoReadByType.action?islive=${video.islive}"><s:property value="%{getText('video.return')}"/></a></li>
        	<li><a href="#"><s:property value="%{getText('video.content')}"/></a></li>
        	<li><a href="#"><s:property value="%{getText('video.edit')}"/></a></li>
